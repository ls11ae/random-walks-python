...
from random_walk_package.bindings import get_tensor_map_terrain, Animal, terrain_map_free, kernels_map3d_free
    ...
    def _setup_initial_configuration(self) -> None:
        ...
        if self.terrain is not None:
            if self.kernel_mapping is None:
                self.kernel_mapping = create_brownian_kernel_parameters(Animal.TERRESTRIAL, self.S)
