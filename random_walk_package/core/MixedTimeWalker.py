...
from random_walk_package import dll, WATER, walk_to_json, create_point2d_array, TERRESTRIAL
        ...
        for animal_id, trajectory in steps_dict.items():
            ...
            for i in range(len(idx) - 1):
                ...
                mapping = marine_kernels_baseline_crw(S, D, angle_diffusity=0.3,
                                                      len_diffusivity=1) if self.is_marine else create_mixed_kernel_parameters(TERRESTRIAL, S)
